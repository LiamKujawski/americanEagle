...
Font:
  Done - We set up the Allura and Alex Brush font family stacks in the CSS but we don't have the fonts included
...
Slideshow:
  Done - We need another slide created from the PSD 
  Done - The styling isn't right yet for slide content as well
  Done - We also haven't been able to set up the slide functionality
...
Responsive:
  ...
  Done - Also when you shrink down the browser some sort of content is causing a horizontal scrollbar in smaller screens
